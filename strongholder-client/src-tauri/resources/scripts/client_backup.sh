...
echo "PROGRESS: 10"
echo "FILE: Requesting secure tunnel port..."
...
echo "PROGRESS: 20"
echo "FILE: Establishing reverse tunnel..."
...
echo "PROGRESS: 30"
echo "FILE: Preparing server encryption keys..."
...
echo "PROGRESS: 40"
echo "FILE: Transfering your data..."
...
echo "PROGRESS: 90"
echo "FILE: Cleaning up server keys..."
